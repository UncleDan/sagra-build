...
# ============================================================
# build-default.sh
# Costruisce l'AppImage della variante DEFAULT direttamente da Linux
# (anche da sessione live).
#
# Sorgente dell'applicazione, in ordine di priorita':
#   1. percorso passato come argomento:   ./build-default.sh /media/d/C-SISTEMA/SAGRA
#   2. contenuto gia' presente in appdata/
#   3. ricerca automatica sui dischi montati
#
# Output: dist/GestioneStandGastronomico-x86_64.AppImage
# ============================================================
set -e
...
WIN_DIRNAME="SAGRA"
APP_NAME="GestioneStandGastronomico"
